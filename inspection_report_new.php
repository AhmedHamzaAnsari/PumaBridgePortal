...
<body>
            ...
            .then(response => {
                ...
                if (response.length > 0) {
                    ...
                    $.each(response, function(index, data) {
                        ...
                        var stock_recon = (data.stock_variations_status == 1) ? stock_recon_btn : "---";
    ...
    function get_recon_stock(task_id, dealer_id, dealer_name, isp_date, comp_date, username, type, last_visit_id) {
        ...
        fetch("<?php echo $api_url; ?>get/new_recon/get_dealer_stock_recon_new.php?key=03201232927&task_id=" +
